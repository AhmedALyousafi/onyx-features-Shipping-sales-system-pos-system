...
import 'package:onyx/features/Shipping-System/features/shipping/presentation/pages/tab_pages/widgets/tab_document_form_fields.dart';
import 'package:onyx/features/Shipping-System/features/shipping/presentation/pages/tab_pages/widgets/tap_Insurance_widgets.dart';
...
class ShipingdocumentForm1 extends StatefulWidget {
  const ShipingdocumentForm1({super.key});
  final bool isCollapsed = false;
  @override
  State<ShipingdocumentForm1> createState() => _TabsAndPagesState();
}

class _TabsAndPagesState extends State<ShipingdocumentForm1>
