...
class ShipingheaderTableOrders extends StatefulWidget {
  @override
  // ignore: library_private_types_in_public_api
  _ShipingheaderTableOrdersState createState() =>
      _ShipingheaderTableOrdersState();
}

class _ShipingheaderTableOrdersState extends State<ShipingheaderTableOrders> {
    ...
    return _buildHeaderRow(children: [
      ...
      _iconButtonWidget(FontAwesomeIcons.print, printColor, onPressed: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => ShipingdashboardPage()));
      }),
      _buildAddButton(),
      const Spacer(),
